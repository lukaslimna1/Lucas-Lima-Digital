...
### `INDUSTRIAL STANDARD V6.0.2` • `HYBRID EXPERIENCE ARCHITECTURE`
...
*   **v6.0.2 (ATUAL)**:
    ...
    *   `LIGHT_MODE_CAPTION_OPTIMIZATION`: Overhaul de contraste nas legendas de galeria para o modo claro.
