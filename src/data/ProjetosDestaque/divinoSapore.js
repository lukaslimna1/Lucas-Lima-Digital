export const divinoSapore = {
  ...
  images: [
    ...
    { src: 'divino-sapore/menu.jpg', alt: 'Cardápio Digital', title: 'Navegação Sensorial' },
    { src: 'divino-sapore/mobile.jpg', alt: 'Versão Mobile', title: 'Alta Performance Mobile' },
    { src: 'divino-sapore/checkout.jpg', alt: 'Processo de Checkout', title: 'Conversão Elegante' },
    { src: 'divino-sapore/dashboard.jpg', alt: 'Painel Administrativo', title: 'Controle de Precisão' }
  ],
  roadmap: ['App Nativo iOS/Android', 'Sistema de Fidelidade Gourmet', 'Integração com Cozinhas Inteligentes']
};
